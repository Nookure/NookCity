...
public class MotdConfig {
    ...
    public List<MotdPartial> motds =
            List.of(
                    ...
                    new MotdPartial(
                            ...
                            """,
                            "<757",
                            new VersionPartial(-1, "Nookure Network 🚫")));
    ...
    public static class MotdPartial {
        ...
        @Setting public String condition = ">=757";

        @Setting public VersionPartial version = new VersionPartial();
    }
