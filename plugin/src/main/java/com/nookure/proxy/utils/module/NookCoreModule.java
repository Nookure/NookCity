...
import com.nookure.proxy.utils.Constants;
...
public class NookCoreModule extends AbstractModule {
    ...
    public NookCoreModule(Path dataFolder, ProxyServer proxyServer) {
        ...
        if (System.getProperty("npu.debug") != null) {
            debug.set(Boolean.parseBoolean(System.getProperty("npu.debug")));
        }
    }
    ...
    protected void configure() {
        ...
        bind(String.class).annotatedWith(PluginName.class).toInstance("NPU");
